...
function(export_obs_core target exportname)
    #install命令规定了安装工程中的目标（targets）的规则
    ...
    #export 导出target到文件(FILE指定的)
    export(TARGETS ${target} FILE "${CMAKE_CURRENT_BINARY_DIR}/${exportname}Target.cmake")
    #将当前的构建目录存储在CMake用户包注册表中，用于包< name >。find_package命令可以在搜索包< name >时考虑目录
    #这有助于依赖项目在没有用户帮助的情况下找到并使用当前项目构建树中的包。
    #注意，这个命令创建的包注册表中的条目只与构建树的包配置文件(<name>Config.cmake)相结合。
