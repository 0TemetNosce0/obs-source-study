...
void OBSBasicSettings::LoadSimpleOutputSettings()
{
    ...
    ui->simpleOutputPath->setText(path);//输出路径
...
void OBSBasicSettings::SaveOutputSettings()//保存输出设置
{
    ...
    SaveEdit(ui->simpleOutputPath, "SimpleOutput", "FilePath");//保存输出路径
